                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <a href="{{route('lis_category')}}">Listing Category</a>
                            </li>

                            <li class="breadcrumb-item active">Add Listing Category</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <div class="card-tools">
                            <a href="{{ route('lis_category') }}" class="btn btn-primary">
                    ...
                    >
                        <h3 class="card-title text-primary px-4">Other Details</h3>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <div>
                    ...
                    <div
                        ...
                        style="background-color: #f8f9fc"
                    >
                        <h3 class="card-title text-primary px-4">Meta</h3>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <div>
                                <label for="meta_textarea"> Meta</label>
                                <textarea
                                    class="form-control"
                                    name="meta_textarea"
                                    id=""

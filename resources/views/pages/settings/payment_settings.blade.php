                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">
                                    <a href="{{route('payment_settings')}}">Settings</a>
                                </li>
...
">
                <h5 class="col-md-4 mt-2 ml-1">Edit payment setting</h5>
                <a class="btn btn-primary position-relative mb-2 mr-2 " href="{{ route('dashboard') }}">
                    Back
                </a>
